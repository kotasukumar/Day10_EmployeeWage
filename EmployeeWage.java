...
import java.util.Scanner;
    ...
    public class EmployeeWage {
        static final int ISFULLTIME = 8;
        static final int ISPARTTIME = 4;
        int days = 0;
        int hours = 0;
        int monthlyWage = 0;
        ...
        int calculateWage(int randInt, Company company) {
            ...
            switch (randInt) {
                case 1:
                    dailyWage = ISFULLTIME * company.wagePerHour;
                    return dailyWage;

                case 2:
                    dailyWage = ISPARTTIME * company.wagePerHour;
                    return dailyWage;
                default:
                    return dailyWage;
            }
        ...
        public static void main(String[] args) {
            ...
            while (true) {
                ...
                System.out.println("Enter 0 to add the company or enter 1 to see the company and its total wage " +
                        ": Press 2 to quit");
